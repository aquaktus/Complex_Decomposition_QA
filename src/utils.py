...
class Info_Plotter:
    ...
    def tabulate_rewrites(self, samples):
        table = wandb.Table(columns=["q_id", "Raw query", "Re-write", "Manual", "Model output", "ndcg_cut_3", 'recall_1000'])
        for sample_obj in samples:
            ...
            table.add_data(sample_obj['q_id'], sample_obj['raw query'], sample_obj['re-write'], sample_obj['manual query'], model_output, ndcg_cut_3, recall_1000)
